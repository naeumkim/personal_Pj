	...
	<div class="wrap">
			<div class="header">
				...
				<ul class="nav">
					...
					<li><a href="../uploadboard/uploadList.jsp">자료실</a></li>
	...
	<div class="main_text0">
        <ul class="icons">
          <li>
            ...
            <div>
             	<b style="color: red;">11% </b>할인  8590원 
            </div>
            <div class="more">
              MORE
            </div>
          ...
          <li>
            ...
            <div>
             <b style="color: red;">25% </b> 할인  21900원 
            </div>
            <div class="more">
              MORE
            </div>
          ...
          <li>
            ...
            <div>
             	<b style="color: red;">50% </b> 할인 6200원 
            </div>
            <div class="more">
              MORE
            </div>
          ...
          <li>
            ...
            <div>
             	<b style="color: red;">8% </b> 할인  14800원 
            </div>
            <div class="more">
              MORE
            </div>
      ...
      <div class="main_text1">
        ...
        <div class="service">
          <div class="food_photo">
            <img src='../inc/image/drink.jpg' style="width: 600px; height: 500px;">
          </div>
          <div class="contents2">
              <h2>오늘 고르는 내일의 한끼</h2>
