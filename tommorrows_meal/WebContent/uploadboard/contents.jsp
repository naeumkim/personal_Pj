...
<div class="main-div">
	<div class="main-left">
			...
			UploadBean bb = bdao.getBoard(num);
			%>
			
			<h4 style="padding: 50px 0 50px 0;">자료실</h4>
			...
			<table class="table">
				...
				<td><%=bb.getSubject() %></td>
				<td>파일</td>
				<td><a href="../upload/<%=bb.getFile()%>"><%=bb.getFile() %></td>
				</tr>
				<tr>
				<td>글 내용</td>
				<td colspan="3"><%=bb.getContent() %>
				...
				<tr>
					...
					<input type="button" value="목록으로" onclick="location.href='uploadList.jsp?pageNum=<%=pageNum%>';" class="btn btn-outline-primary">
